                ...
                <div className="col-8">
                    <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li className="nav-item">
                            <button className={`nav-link ${filter === 'all' && 'active'}`} type="button" onClick={() => handleFilter('all')}>All</button>
                        </li>
                        <li className="nav-item">
                            <button className={`nav-link ${filter === 'active' && 'active'}`} type="button" onClick={() => handleFilter('active')}>Active</button>
                        </li>
                        <li className="nav-item">
                            <button className={`nav-link ${filter === 'completed' && 'active'}`} type="button" onClick={() => handleFilter('completed')}>Completed</button>
                        </li>
                    </ul>
